...
from emo.assets.infra.dependencies import release_uow, message_bus
...
async def get_all_transfers(
    ...
    return [schemas.ReleaseResponse(**r)
...
@router.post(
    ...
    "If successful, redirects to the asset file upload" +
...
async def add_asset(
    ...
    payload["owner"] = [
        o.replace("/users/", "") for o in create.owner
    ]
