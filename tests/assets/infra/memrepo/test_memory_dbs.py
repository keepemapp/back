...
class TestAssetRepo:
    ...
    def test_create(self, tmpdir, valid_asset):
    ...
    def test_cannot_create_two_assets_same_id(self, asset_repo, valid_asset):
        r = asset_repo
        a = Asset(**valid_asset)
        r.create(a)
        assert len(r.all()) == 1
    ...
    def test_find_by_id(self, asset_repo, valid_asset):
        r = asset_repo
        a = Asset(**valid_asset)
        r.create(a)
    ...
    def test_find_multiple_ids(self, asset_repo, valid_asset):
        r = asset_repo
        a = Asset(**valid_asset)
        r.create(a)
